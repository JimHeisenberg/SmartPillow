            ...
            renderItem={item => (
                <List.Item
                    ...
                    actions={[
                        ...
                        <Icon type="close-circle" onClick={()=>{axios.post('/api/setting',{"Action":"delete","Token":localStorage.getItem('Token'),"Data":[{"TimeID":item.description,"SleepingTime":"13:30:00", "WakeupTime":"14:00:00"}]},{headers: {'Content-Type': 'application/json'}}).then(function (response) {
